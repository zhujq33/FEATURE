def figure_2():
    ...
    if image_lower_bound > 0 and image_upper_bound > 0:
        plt.ylim(image_lower_bound, image_upper_bound)
    else:
        print("Error: Y-axis bounds must be positive for log-scale.")
    ...
    proxy_handle = Line2D([0], [0], color='blue', marker='o', linestyle='None')
    plt_handler = [proxy_handle]
